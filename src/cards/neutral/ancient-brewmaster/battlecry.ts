...
@useModel('ancient-brewmaster-battlecry-model')
export class AncientBrewmasterBattlecryModel extends BattlecryModel<RoleModel> {
    protected _brand: symbol = Symbol('ancient-brewmaster-battlecry-model');
