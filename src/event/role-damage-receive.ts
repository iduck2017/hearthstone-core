...
export function useRoleDamageReceivePrevEventConsumer<I extends Model & { role: RoleModel | undefined }>() {
    return function(
        prototype: I,
        key: string,
        descriptor: TypedPropertyDescriptor<(event: RoleDamageReceivePrevEvent, target: RoleModel) => void>
    ) {
...
export function useRoleDamageReceiveEventConsumer<I extends Model & { role: RoleModel | undefined }>() {
    return function(
        prototype: I,
        key: string,
        descriptor: TypedPropertyDescriptor<(event: RoleDamageReceivePostEvent, target: RoleModel) => void>
    ) {
